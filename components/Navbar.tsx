...
function Navbar() {
  return (
    <nav className="fixed w-full top-0 h-10 z-50 text-zinc-600 font-light text-center">
      <div className="absolute h-full w-full blur-sm bg-gray-200"></div>
      <div className="absolute h-full w-full backdrop-blur-md"></div>
      <ul className="flex flex-row justify-center h-full items-center text-sm space-x-6 md:space-x-12">
